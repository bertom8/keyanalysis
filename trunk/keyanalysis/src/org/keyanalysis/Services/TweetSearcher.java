...
public class TweetSearcher {
	...
	public static void saveTweetsFromJson(final File file) {
		if (file == null) {
			return;
		}
					...
					if (!o.get("geo").isJsonNull()) {
						if (o.get("geo").getAsJsonObject().isJsonObject()) {
							if (o.get("geo").getAsJsonObject().get("coordinates").isJsonArray()) {
								if (o.get("geo").getAsJsonObject().get("coordinates").getAsJsonArray().get(1)
										.isJsonPrimitive()) {
									t.setGeoLatitude(o.get("geo").getAsJsonObject().get("coordinates").getAsJsonArray()
											.get(1).getAsDouble());
								}
								if (o.get("geo").getAsJsonObject().get("coordinates").getAsJsonArray().get(0)
										.isJsonPrimitive()) {
									t.setGeoLongitude(o.get("geo").getAsJsonObject().get("coordinates").getAsJsonArray()
											.get(0).getAsDouble());
								}
							}
						}
